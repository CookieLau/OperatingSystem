...
#define PDX(va)		((((u_long)(va))>>22) & 0x03FF)//get [31:22]
#define PTX(va)		((((u_long)(va))>>12) & 0x03FF)//get [21:12]
#define PTE_ADDR(pte)	((u_long)(pte)&~0xFFF)//get [31:12] of address:the physical head 
